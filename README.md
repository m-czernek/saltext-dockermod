# Salt Extension for Dockermod

Salt Extension for interacting with Dockermod
...
The saltext-dockermod project welcomes contributions from anyone!
...
```bash
# Clone the repo
git clone --origin upstream git@github.com:salt-extensions/saltext-dockermod.git

# Change to the repo dir
cd saltext-dockermod
```
...
* Writing blog posts
* Sharing your experiences using Salt + Dockermod
  on social media
...
[PRs]: https://github.com/salt-extensions/saltext-dockermod/pulls
[discussions]: https://github.com/salt-extensions/saltext-dockermod/discussions
